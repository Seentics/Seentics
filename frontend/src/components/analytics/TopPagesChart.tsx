...
import { FileText, Home, Globe, ChevronRight, User, Phone, DollarSign, Package, BarChart3, Workflow, CreditCard, HelpCircle, Palette, LogIn, Settings, ShoppingCart, Info, Mail, Calendar, Users, Shield, Zap } from 'lucide-react';
